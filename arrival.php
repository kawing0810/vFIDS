...
<table class="table <?php echo $default_lang; ?>" id="table" cellspacing="0" cellpadding="0">
    <thead>
        <tr>
            <th class="lang" data-lang="ARRIVAL" data-lang-init="zh,en" colspan="3" style="text-align:left;">Arrival</th>
        ...
        <tr>
            ...
            <th class="lang" data-lang="FROM" data-lang-init="zh">From</th>
            <th class="lang" data-lang="FROM" data-lang-init="en">From</th>
...
$(function() {
    ...
    function showTable(tbody) {
        ...
        for(var idx=spos; idx < epos; idx++) {
            ...
            var tdDestZh = $('<td/>', {html:row.departName}).appendTo(tr);
            $('<span/>', {class:'zhx', html:row.departName['zh']}).appendTo(tdDestZh);

            var tdDestEn = $('<td/>').appendTo(tr);
            $('<span/>', {class:'enx', html:row.departName['en']}).appendTo(tdDestEn);

            var tdTime = $('<td/>', {html:row.eta.replace(':', '')}).appendTo(tr);
